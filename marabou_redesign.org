#+TODO:  TODO(t) NEW(n) NEXT(x) | DONE(d)
...
- by splitting (in SmtCore::decideSplit())
...
- Expectation: asserting alternative cases is done using chooseSplitCase() and  decideSplit(case)
...
New implementation of decideSplit and popSplit
...
**** implyValidSplit -> Implications, could be more than just ReLUs in the future.
