...
***** TODO ConstraintBoundTightener
****** Shadows calls to BoundManager for now
****** TODO Migrate Flags to indicate who sourced the new bound to BM

****** Will be factored out eventually
***** TODO Tableau 
****** DONE Add the member to the class
CLOSED: [2020-06-30 Tue 16:16]
****** TODO Shadowing calls
******* Partially done, revisit
****** Mark redundant functions
***** Constraints
****** Have local copies of bounds
****** Want to replace them with central versions 
